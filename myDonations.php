            ...
            <div class="row row-header row-span-3">
                ...
                <div class="col-12 col-sm-2 align-self-center">
                    <div class="row row-header">
                        <?php
                                $em = $_GET['user_email'];
                                echo "<a role='button' class='btn btn-block nav-link btn-warning text-left' style='color:white' href='userHome.php?user_email=$em'><span class='fa fa-arrow-circle-left'></span> Back</a>";
                          ?>
                    </div><br>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row row-content justify-content-center">
                <?php
                    ...
                    $sql = "SELECT medicine_name,quantity,donation_date,status from donations where email='$email'";
                    $result = $conn-> query($sql);
                    if($result-> num_rows > 0) {
                        echo "<table><tr><th>Medicine Name</th><th>Quantity</th><th>Donation Date</th><th>Status</th></tr>";
                        ...
                        echo "<script type='text/javascript'>window.alert('No donation yet. Donate now!');</script>";
