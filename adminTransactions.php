...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center"><h6>NGOs Transactions :</h6></div>
        <div class="row row-content justify-content-center">
            <?php
                ...
                $sql = "SELECT email,medicine_name,quantity,date_of_collection,status from requested_medicines";
                $result = $conn-> query($sql);
                if($result-> num_rows > 0) {
                    echo "<table><tr><th>Email</th><th>Medicine Name</th><th>Quantity</th><th>Date of Collection</th><th>Status</th></tr>";
    ...
    <div class="container">
        <div class="row justify-content-center"><h6>Donar Transactions </h6></div>
        <div class="row row-content justify-content-center">
            <?php
                $email=$_SESSION['myemail'];
                $conn = mysqli_connect("localhost","root","","medicine_donation");
                ...
                $sql = "SELECT email,medicine_name,quantity,donation_date,status from donations";
                $result = $conn-> query($sql);
                if($result-> num_rows > 0) {
                    echo "<table><tr><th>Email</th><th>Medicine Name</th><th>Quantity</th><th>Donation Date</th><th>Status</th></tr>";
                    while($row = $result-> fetch_assoc()) {
                        echo "<tr><td>" . $row["email"] . 
                            "</td><td>" . $row["medicine_name"] . 
                            "</td><td>" . $row["quantity"] . 
