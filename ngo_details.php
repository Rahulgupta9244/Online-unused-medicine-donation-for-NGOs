...
<body>
    ...
    <div class="container">
        <div class="row">
                ...
                <li class="breadcrumb-item">NGO SignUp</li>
    ...
    if(isset($_GET['retry'])==1)
        {
            session_start();
            $name = $_SESSION['nname'];
            $phone=$_SESSION['nphone'];
            $address=$_SESSION['naddress'];
            $email=$_SESSION['nemail'];
            $psw1=$_SESSION['npassword1'];
            $psw2=$_SESSION['npassword2'];
            $otp=$_SESSION['notp'];
            $testflag=1;
        }
        else
        {
            ...
            if($psw1!=$psw2)
            {
                ...
                echo "<meta http-equiv='refresh' content='0;url=index.php?flag8=1'>";
            }
            else
            {
                $sql3="select email from ngo_details where email='$email'";
                ...
                else
                {
                    ...
                    $_SESSION['nname']=$name;
                    $_SESSION['naddress']=$address;
                    $_SESSION['nphone']=$phone;
                    $_SESSION['npassword1']=$psw1;
                    $_SESSION['npassword2']=$psw2;
                    $_SESSION['notp']=$otp;
