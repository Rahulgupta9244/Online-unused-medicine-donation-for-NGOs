    ...
    <div class="container">
        <div class="row row-content justify-content-center">
            <?php
                ...
                $sql = "SELECT medicine_name,quantity,date_of_collection,status from requested_medicines where email='$email'";
                $result = $conn-> query($sql);
                if($result-> num_rows > 0) {
                    echo "<table><tr><th>Medicine Name</th><th>Quantity</th><th>Date of Collection</th><th>Status</th></tr>";
                    ...
                    echo "<script type='text/javascript'>window.alert('No transactions yet !');</script>";
