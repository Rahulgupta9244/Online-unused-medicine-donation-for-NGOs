...
if(mysqli_connect_error()) {
    die('Connect Error('. mysqli_connect_errno().')'. mysqli_connect_error());
        ...
        if($otp==$otp2){
            $SELECT = "SELECT email from ngo_details where email = ? Limit 1";
            $INSERT = "INSERT into ngo_details values(?,?,?,?,?)";
            ...
            echo "<meta http-equiv='refresh' content='0;url=index.php?flag6=1'>";
                ...
                echo "<meta http-equiv='refresh' content='0;url=ngo_details.php?retry=1'>";
            }
