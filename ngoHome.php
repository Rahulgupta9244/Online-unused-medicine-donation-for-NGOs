        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                ...
                <span class="navbar-text">
                    ...
                    ?>
                    <a role="button" id="ngoLogoutButton" href="#" onclick="logoutfunction()"><span class="fa fa-sign-out"></span> Logout</a>
                </span>
            </div>      
        </div>
    </nav>
        ...
        <div class="modal-dialog modal-lg" role="content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="changeNgoPass.php" method="POST" class="login-form">
                        <div class="form-group col-md-5">
                            ...
                            <br><br>
                            <div class="form-group row ml-2">
                                <input type="text" class="form-control form-control-sm mr-1" id="email31" name="email21">
                                <label class="sr-only" for="changePassword12">Enter Old Password</label>
                                <input type="password" class="form-control form-control-sm mr-1" id="changePassword1" placeholder="Enter Password" name="oldPass" required>
                            </div>
                            <div class="form-group row ml-2">
                                <label class="sr-only" for="changePassword22">Enter New Password</label>
                            ...
                            <div class="form-group row ml-2">
                                <label class="sr-only" for="changePassword32">Re-enter Password</label>
                        ...
                        <?php
                                $em = $_GET['user_email'];
                                echo "<script type='text/javascript'>document.getElementById('email31').value='$em';document.getElementById('email31').style.display='none';</script>";
                          ?>
                    </form>
                </div>
            </div>
            ...
            <div class="row row-header row-span-3">
                ...
                <div class="col-12 col-sm-3 align-self-center">
                    <div class="row row-header">
                        <?php
                                $em = $_GET['user_email'];
                                echo "<a role='button' class='btn btn-block nav-link btn-warning text-left' style='color:white' id='availableMedicines'  href='available_medicines.php?user_email=$em'><span class='fa fa-sign-in'></span> Available Medicines</a></div><br><div class='row row-header'><a role='button' class='btn btn-block nav-link btn-warning text-left' style='color:white' id='myTransactions' href='medicines_granted.php?user_email=$em'><span class='fa fa-sign-in'></span> My Transactions</a></div><br>";
                        ?>
                        <div class="row row-header">
