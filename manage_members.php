...
<head>
    ...
    <script type="text/javascript">
                                    function fn1(email){
                                    document.getElementById('blockUserModal2').showModal();
                                    document.getElementById('blockedemail2').value = email;
                                    }
                                    function fn2()
                                    {
                                      document.getElementById('blockUserModal2').hidden=true;
...
//                    $email=$_SESSION['myemail'];
                    ...
                    $sql = "SELECT name,email,phone,address from user_details";
                    $result = $conn-> query($sql);
                    if($result-> num_rows > 0) {
                        echo "<table><tr><th>Name</th><th>Email</th><th>Phone</th><th>Address</th><th>Block</th></tr>";
                        while($row = $result-> fetch_assoc()) {
                            ...
                            echo "<tr><td>" . $row["name"] . 
                                ...
                                "</td><td>" . $row["phone"] .
                                "</td><td>" . $row["address"] .
                                "</td><td><button style='width:100%' id='blockUserBtn' name='$em' onclick='fn1(this.name)'>Block</button></td></tr>";
                        }
                        echo "</table>";
                    }
                    else {
                        echo "<script type='text/javascript'>window.alert('No users available !');</script>";
    ...
    <dialog id="blockUserModal2"><div><h6>Confirm Blocking?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="btncancel" onclick="fn2()">Close</button></h6></div>
    <form action="block_user.php" method="post"><input type="text" id="blockedemail2" name="email99"><button type="submit">Block</button>
      </form>  
    </dialog>
