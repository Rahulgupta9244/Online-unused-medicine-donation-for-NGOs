<?php
        ...
        {
            session_start();
            $email77=$_SESSION['fEmail3'];
        }
        else
        {
            $email77=$_POST['email33'];
            session_start();
            $_SESSION['fEmail3']=$email77;
        }
        ...
        $sql="select email from ngo_details where email='$email77'";
        $result=mysqli_query($con,$sql);
        if($result->num_rows==0)
        {
            echo "<script type='text/javascript'>window.alert('Email not registered.');</script>";
            echo "<meta http-equiv='refresh' content='0;url=index.php?flag15=1'>";
        }
        else
        {
        if(isset($_GET['retry'])==1)
...
<body>
    ...
    <div class="container">
        <div class="row row-content justify-content-center">
          <form action="forgotPassNGO2.php" method="post">
